...
# Overrides the load textdomain function for the 'dk_waves' domain.
...
/**
 * Overrides the load textdomain functionality when 'dk_waves' is the domain in use.  The purpose of
 * this is to allow theme translations to handle the framework's strings.  What this function does is
 * sets the 'dk_waves' domain's translations to the theme's.  That way, we're not loading multiple
 ...
 */
function hybrid_load_framework_textdomain( $domain = 'dk_waves' ) {
